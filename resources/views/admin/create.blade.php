@section('content')
    ...
    <div class="container">
        ...
        {!! Form::open() !!}
        {!! Form::hidden('menu_id', Request::old("menu_id", $menu_id?:0)) !!}
        {!! Form::hidden('parent_id', Request::old("parent_id", $parent_id)) !!}
        <div class="card card-default">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="menu-link">
                            ...
                            {!! Form::text('url', Request::old("url"), ['id' => 'url', 'class' => 'form-control']) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('groups', 'Group Permissions', ['data-toggle'=>'tooltip', 'title'=>'Only these groups will have permission to view this link.']) !!}
                            {!! Form::select('groups[]', $user_groups, [], ['class'=>'select','placeholder'=>'Allow only..', 'multiple' => 'multiple']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('get.admin.menuitem.index', [$menu_id]) }}" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
        {!! Form::close() !!}
